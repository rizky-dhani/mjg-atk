...
use App\Filament\Resources\MarketingMediaStockMovementResource\Pages;
use App\Filament\Resources\MarketingMediaStockMovementResource\RelationManagers;
...
class MarketingMediaStockMovementResource extends Resource
{
    protected static ?string $model = MarketingMediaStockMovement::class;
    ...
    {
        return [
            'index' => Pages\ListMarketingMediaStockMovements::route('/'),
            'view' => Pages\ViewMarketingMediaStockMovement::route('/{record}'),
        ];
    }
}