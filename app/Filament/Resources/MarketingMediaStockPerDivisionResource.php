...
use App\Filament\Resources\MarketingMediaStockPerDivisionResource\Pages;
use App\Filament\Resources\MarketingMediaStockPerDivisionResource\RelationManagers;
...
class MarketingMediaStockPerDivisionResource extends Resource
{
    ...
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                Infolists\Components\Section::make('Marketing Media Item Details')
                    ->schema([
    ...
    {
        return [
            'index' => Pages\ListMarketingMediaStocksPerDivision::route('/'),
            'view' => Pages\ViewMarketingMediaStockPerDivision::route('/{record}'),
        ];
    }
}
