...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('mm_stock_requests', function (Blueprint $table) {
            ...
            $table->foreignId('approval_second_ga_admin_id')->nullable()->constrained('users')->cascadeOnDelete();
            $table->timestamp('approval_second_ga_admin_at')->nullable();

            $table->foreignId('rejection_second_ga_admin_id')->nullable()->constrained('users')->cascadeOnDelete();
            $table->timestamp('rejection_second_ga_admin_at')->nullable();
